...
module.exports.artistsIdAlbumsGET = function artistsIdAlbumsGET(req, res, next, id, limit, offset) {
    try {
        ArtistsService.artistsIdAlbumsGET(id, limit, offset)
            .then(function (response) {
                utils.writeJson(res, response);
            })
            .catch(function (error) {
                console.error('Error in artistsIdAlbumsGET:', error);
                utils.writeJson(res, {error: error.message}, error.code || 404);
            });
    } catch (error) {
        console.error('Unexpected error in artistsIdAlbumsGET:', error);
        utils.writeJson(res, {error: 'Internal Server Error'}, 500);
    }
}
